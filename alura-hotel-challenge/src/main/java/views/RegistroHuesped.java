...
import DAOS.RegistroHuespedesDAO;
...
public class RegistroHuesped extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RegistroHuesped frame = new RegistroHuesped(idvalues);
	 ...
	 * Create the frame.
	 */
	public RegistroHuesped(int idvalue) {
		...
		txtNreserva = new JTextField(Integer.toString(idvalues));
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				RegistroHuespedesDAO RHD = new RegistroHuespedesDAO(factory.recuperaConexion());
				RHD.guardarHuespedes(txtNombre.getText(), txtApellido.getText(), txtFechaN.getDate(),
						(String) txtNacionalidad.getSelectedItem(), txtTelefono.getText(), txtNreserva.getText());
				JOptionPane.showMessageDialog(null, "Se guardo la informacion del huesped", "Información",
	...
	//	if(idvalues > 0 ) {
	//		JOptionPane.showMessageDialog(null, "Su numero de reserva es: " + idvalues, "Información",
	//				JOptionPane.INFORMATION_MESSAGE);
	//	}
