...
public class ReservasView extends JFrame {
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if (txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null) {
					Long diferenciaMilisegundos = (txtFechaSalida.getDate().getTime()
							- txtFechaEntrada.getDate().getTime());
					Long diferenciaDias = diferenciaMilisegundos / (24 * 60 * 60 * 1000);
					if (diferenciaDias > 0) {
						Long price = diferenciaDias * 500l;
						txtValor.setText(Long.toString(price));
					}
				}
			}
		});
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {
					...
					reservasDAO guardar = new reservasDAO(factory.recuperaConexion());
					try {
						guardar.guardarreservas(txtFechaEntrada.getDate(), txtFechaSalida.getDate(), txtValor.getText(),
								(String) txtFormaPago.getSelectedItem());

						idvalue = guardar.GetIdreservation(txtFechaEntrada.getDate(), txtFechaSalida.getDate(), txtValor.getText(),
								(String) txtFormaPago.getSelectedItem());
						JOptionPane.showMessageDialog(null, "Se guardo la informacion de reserva", "Información",
								JOptionPane.INFORMATION_MESSAGE);
						RegistroHuesped registro = new RegistroHuesped(idvalue);
	...
	private String valordeestadia(JDateChooser txtFechaEntrada2, JDateChooser txtFechaSalida2) {
